        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: white;">
                    <h3 class="mb-3" style="font-family: var(--font-headings); font-weight: 700; color: var(--primary-color);"><?php echo t(
                        "history_title",
                    ); ?></h3>
                    <p class="text-muted" style="line-height: 1.7;"><?php echo t(
                        "history_text",
                    ); ?></p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: white;">
                    ...
                    <p class="text-muted mb-0" style="line-height: 1.7;"><?php echo t(
            ...
            <div class="col-12 mt-4">
                <div class="card border-0 shadow-sm p-4" style="border-radius: 16px; background: white;">
                    <h3 class="mb-3" style="font-family: var(--font-headings); font-weight: 700; color: var(--primary-color);"><?php echo t(
                        "history_achievements_title",
                    ); ?></h3>
                    <p class="text-muted mb-4"><?php echo t(
                        "history_achievements_intro",
                    ); ?></p>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item border-0 bg-transparent text-muted">&#8226; <?php echo t(
