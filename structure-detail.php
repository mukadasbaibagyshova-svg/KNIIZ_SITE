...
<div class="dept-main-content">
    ...
    <section class="dept-section dept-intro-section sd-reveal">
        <h2 class="dept-section-title" id="dept-intro-heading"><?php echo t('structure_detail_intro'); ?></h2>
        ...
        <div class="dept-intro-photo-col">
            ...
            <?php else: ?>
                <div class="dept-intro-photo-placeholder">
                    ...
                    <span><?php echo t('structure_detail_photo_placeholder'); ?></span>
                </div>
            <?php endif; ?>
        </div>
        </div>
    ...
    <section class="dept-section dept-staff-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_staff_title'); ?></h2>
        <div class="dept-staff-grid">
            ...
            ?>
                <article class="dept-staff-card is-head">
                    ...
                    <?php endif; ?>
                    <span class="dept-staff-badge"><?php echo t('structure_detail_head'); ?></span>
                </article>
            <?php endif; ?>
            ...
            ?>
                <article class="dept-staff-card<?php echo $isHead ? ' is-head' : ''; ?>">
                    ...
                    <?php
                    $meta = [];
                    if (!empty($member['degree']) && $member['degree'] !== 'нет' && $member['degree'] !== 'none' && $member['degree'] !== 'жок') $meta[] = $member['degree'];
                    if (!empty($member['experience'])) $meta[] = t('structure_detail_experience') . ' ' . $member['experience'] . ' ' . t('structure_detail_years');
                    if ($meta):
                    ?>
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_research_title'); ?></h2>
    ...
    ?>
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_results_title'); ?></h2>
    ...
    ?>
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_international_title'); ?></h2>
        <div class="dept-feature-cards">
            <?php if (!empty($detail['international'])): ?>
                <article class="dept-feature-card dept-feature-card--intl">
                    ...
                    <div class="dept-feature-card__body">
                        <h3><?php echo t('structure_detail_international_coop'); ?></h3>
            ...
            <?php if (!empty($detail['projects_current'])): ?>
                <article class="dept-feature-card dept-feature-card--intl">
                    <div class="dept-feature-card__icon" aria-hidden="true">📌</div>
                    <div class="dept-feature-card__body">
                        <h3><?php echo t('structure_detail_projects_current'); ?></h3>
            ...
            <?php if (!empty($detail['projects_completed'])): ?>
                <article class="dept-feature-card dept-feature-card--intl">
                    <div class="dept-feature-card__icon" aria-hidden="true">✅</div>
                    <div class="dept-feature-card__body">
                        <h3><?php echo t('structure_detail_projects_completed'); ?></h3>
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_publications_title'); ?></h2>
        <div class="dept-feature-cards">
            <article class="dept-feature-card dept-feature-card--pub">
                <div class="dept-feature-card__icon" aria-hidden="true">📚</div>
                <div class="dept-feature-card__body">
                    <h3><?php echo t('structure_detail_publications_desc'); ?></h3>
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_goals_title'); ?></h2>
        <ul class="dept-list">
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_perspectives_title'); ?></h2>
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_services_title'); ?></h2>
        <div class="dept-research-grid">
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_events_title'); ?></h2>
    ...
    <section class="dept-section sd-reveal">
        <h2 class="dept-section-title"><?php echo t('structure_detail_infrastructure_title'); ?></h2>
